 ...
 * @src: source string
 * @i: index of begining char from source string
 * @str_len: string lenght
 *
 * Return: next index to check for source string
 */
...
/**
 * word_count - counts words in an input string
 * @str: input string
 * @str_len: string lenght
 *
 * Return: words on success
 */
